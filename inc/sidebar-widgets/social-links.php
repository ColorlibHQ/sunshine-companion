...
class Sunshine_social_links extends WP_Widget {
    ...
    function __construct() {
        ...
        'sunshine_social_links',


        // Widget name will appear in UI
        esc_html__( '[ Sunshine ] Social Links', 'sunshine-companion' ),

        // Widget description
        array( 'description' => esc_html__( 'Add footer social links.', 'sunshine-companion' ), )
        );
    ...
    public function form( $instance ) {
        ...
        $title = isset( $instance[ 'title' ] ) ? $instance[ 'title' ] : esc_html__( 'Follow Us', 'sunshine-companion' );
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'facebook' ) ); ?>"><?php esc_html_e( 'Facebook URL:' ,'sunshine-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'twitter' ) ); ?>"><?php esc_html_e( 'Twitter URL:' ,'sunshine-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'linkedin' ) ); ?>"><?php esc_html_e( 'Linkedin URL:' ,'sunshine-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'instagram' ) ); ?>"><?php esc_html_e( 'Instagram URL:' ,'sunshine-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'dribbble' ) ); ?>"><?php esc_html_e( 'Dribbble URL:' ,'sunshine-companion'); ?></label>
...
} // Class sunshine_social_links ends here


// Register and load the widget
function sunshine_social_links_widget_load() {
	register_widget( 'Sunshine_social_links' );
}
add_action( 'widgets_init', 'sunshine_social_links_widget_load' );