...
----------------------------------------*/
class sunshine_instagram_photo extends WP_Widget {
	public function __construct(){
		parent::__construct('sunshine_instagram_photo',esc_html__('[ Sunshine ] Intagram Photo','sunshine-companion'),array(
			'description' => esc_html__('Sunshine Instagram Photo Widget','sunshine-companion'),
		));
	}
	...
	public function form($instance){
		$title      = isset( $instance['title'] ) ? $instance['title'] : esc_html__('Instagram', 'sunshine-companion');
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_user' ) ); ?>"><?php esc_html_e( 'User Name:' ,'sunshine-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_items' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'sunshine-companion'); ?></label>
...
if(!function_exists('sunshine_instagram_widgets')):
	function sunshine_instagram_widgets(){
		register_widget('sunshine_instagram_photo');
	}
	add_action('widgets_init','sunshine_instagram_widgets');
endif;
